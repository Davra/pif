...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        if (typeof options.template !== 'string' && !(options.template instanceof $))
            options.template = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                '</div>' +
                '<button class="cancelBtn" type="button" style="float:right; margin:4px 10px"></button>' +
        ...
        this.container.on('click.daterangepicker', 'button.cancelBtn', $.proxy(this.clickCancel, this))
    ...
    DateRangePicker.prototype = {
        ...
        updateView: function(disableUpdate) {
            if (this.timePicker) {
            ...
            this.updateFormInputs(disableUpdate);
        },
